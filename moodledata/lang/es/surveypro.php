...
/**
 * Strings for component 'surveypro', language 'es', version '4.3'.
 *
 * @package     surveypro
 * @category    string
...
$string['abandoned_submission_deleted'] = 'Respuesta eliminada abandonada';
...
$string['duplicateemail'] = 'Las direcciones de Email deben ser diferentes unas de otras.';
...
$string['neverstartedemail'] = 'Email para encuesta no iniciada';
$string['neverstartedemail_help'] = 'Enviar un Email recordatorio a usuarios que no iniciaron su primer envío';
...
$string['noreportsfound'] = 'No hay reportes en esta instalación de Surveypro.';
...
$string['oneshotemail'] = 'Encuesta de un paso con Email recordatorio';
$string['oneshotnoemail'] = 'Encuesta de un paso sin Email recordatorio';
...
$string['pauseresumeemail'] = 'Permitir pausar/continuar con Email recordatorio';
$string['pauseresumenoemail'] = 'Permitir pausar/continuar sin Email recordatorio';
...
$string['reminderoneshot_content3'] = '<br>Por favor considere ingresar nuevamente a {$a} y enviar pronto.<br><br>El equipo de enseñanza en línea';
...
$string['reminderpaused_content3'] = '<br>Por favor considere ingresar nuevamente a {$a} y enviarla.<br><br>El equipo de enseñanza en línea';
$string['remindneverstarted_content'] = 'Estimado {$a->fullname}<br>; al parecer su contribución a la encuesta "{$a->surveyproname}" aun no ha iniciado.<br>Por favor considere ingresar nuevamente a {$a->surveyprourl} e iniciarla tan pronto como pueda.<br><br>El equipo de enseñanza en línea';
...
$string['unaccesiblepages_note'] = '(Unas pocas páginas podrían no estar accesibles debido a falta de permisos)';

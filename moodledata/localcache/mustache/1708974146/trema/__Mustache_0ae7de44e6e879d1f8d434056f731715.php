...
class __Mustache_0ae7de44e6e879d1f8d434056f731715 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section23c3a6fff8fc131845288df73ba0f585($context, $indent, $value);
        $value = $context->find('badgeurl');
        if (empty($value)) {
...
';
    ...
    private function section23c3a6fff8fc131845288df73ba0f585(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';

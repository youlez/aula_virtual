...
class __Mustache_f130c6c5572dc74e10ee63835c4552f7 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '    <button class="navbar-toggler aabtn d-block d-md-none my-1 mr-2" data-toggler="drawers" data-action="toggle" data-target="theme_boost-drawers-primary">
';
...
';
        ...
        $buffer .= '" class="navbar-brand d-flex align-items-center m-0 p-0 mr-4 aabtn">
';
...
';
        ...
        $buffer .= $this->section623a0ff714dfccbf840468c0c787cb46($context, $indent, $value);
        $buffer .= $indent . '        ';
...
';
    ...
    private function section623a0ff714dfccbf840468c0c787cb46(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
